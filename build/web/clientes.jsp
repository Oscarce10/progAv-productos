                ...
                <div class="card-body">
                    <form action="#" method="GET">
                        ...
                        <div class="form-group row">
                            <div class="col-2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="persona" value="natural" checked>
                                    <label class="form-check-label" for="gridRadios1">
                                        Natural
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="persona" value="juridica">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                <label for="name">Nombre</label>
                                <input type="text" class="form-control" name="nombre_rp">
                            </div>
                            <div class="col">
                                <label for="name">Apellido</label>
                                <input type="text" class="form-control" name="apellido_rp">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col">
                                <label for="name">Documento</label>
                                <input type="text" class="form-control" name="documento_rp">
                            </div>
                            <div class="col">
